"""
Django settings for django_atomiadns project.
...
SECRET_KEY = 'h=_1-z5hwq_uc&65+gz%8+fg33i=#c64-v=k^8#s8evh)roef6'
...
ROOT_URLCONF = 'django_atomiadns.urls'

WSGI_APPLICATION = 'django_atomiadns.wsgi.application'
